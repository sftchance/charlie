...
(
	...
	AND CONTRACT_ADDRESS <> '0x4a3e164684812dfb684ac36457e7fa805087c68e' 
), mints AS
(
...
(
	...
	INNER JOIN contracts
	ON ez_token_transfers.CONTRACT_ADDRESS = contracts.CONTRACT_ADDRESS
	WHERE ez_token_transfers.TO_ADDRESS IN ( lower('0x0000000000000000000000000000000000000000'), lower('0x000000000000000000000000000000000000Dead') )
	GROUP BY  contracts.CONTRACT_ADDRESS
), supply AS
(
